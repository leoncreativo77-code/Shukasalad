...
// Aplica logo/color/fondo/nombre guardados en app_settings (ver BrandScreen)
// al montar la app. Los valores por defecto (declarados como fallback en
// index.css, y "POS Restaurante" para el nombre) hacen que nada cambie
// visualmente hasta que un admin configure algo desde Admin > Marca.
export function useBranding(): Branding {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [primaryColor, logoImageId, backgroundColor, backgroundImageId, name] =
        await Promise.all([
